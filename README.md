...
We are currently working on a complete, ground-up rewrite that will feature **ProjectsBase version 27.0 and above**. Unlike this nightmare, the new repository will be:
* Fully modular
